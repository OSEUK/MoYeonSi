...
if st.session_state.page == "input":
    ...
    skin_color = st.selectbox("피부 색깔을 선택하세요:", ["흑인", "백인", "아시안"])
    gender = st.radio("이상형의 성별을 선택하세요:", ["여성", "남성"])
    ...
    skin_color_en = {"백인": "white", "흑인": "black", "아시안" : "yellow"}[skin_color]
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            ...
            your name is {st.session_state.name}, your gender is {st.session_state.gender}"),
